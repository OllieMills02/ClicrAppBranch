...
export default async function LoginPage({ searchParams }: Props) {
    ...
    const returnTo = (params.returnTo as string) || 'https://clicr.co';
            ...
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-primary/10 mb-6 border border-primary/20 shadow-lg shadow-primary/10">
                        {/* Using img for the logo since we have it in public */}
                ...
                <form className="mt-8 space-y-6">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <button
                            formAction={signup}
                            className="group relative flex w-full justify-center rounded-xl bg-white/5 border border-white/10 py-3 px-4 text-sm font-bold text-slate-300 hover:bg-white/10 hover:text-white transition-all"
                        >
                            Create Account
                        </button>
                    </div>
